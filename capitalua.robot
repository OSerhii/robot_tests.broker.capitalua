...
Підготувати клієнт для користувача
  ...
  Run Keyword If  '${username}' != 'capitalua_Viewer'  Run Keywords
  ...  Login  ${username}
...
Створити тендер
  ...
  Wait Until Page Contains Element  xpath=//a[@href="https://eauction-capital.com.ua/tenders"]  10
  Click Element  xpath=//a[@href="https://eauction-capital.com.ua/tenders"]
  Click Element  xpath=//a[@href="https://eauction-capital.com.ua/tenders/index"]
  Click Element  xpath=//a[contains(@href,"https://eauction-capital.com.ua/buyer/tender/create")]
...
Додати предмет закупівлі
  ...
  capitalua.Пошук тендера по ідентифікатору  ${username}  ${tender_uaid}
...
Завантажити ілюстрацію
  ...
  capitalua.Завантажити документ   ${username}  ${filepath}  ${tender_uaid}  True
...
Пошук тендера по ідентифікатору
  ...
  Switch browser  ${username}
  Go To  https://eauction-capital.com.ua
  Click Element  xpath=//a[@href="https://eauction-capital.com.ua/tenders"]
  Click Element  xpath=//a[@href="https://eauction-capital.com.ua/tenders/index"]
...
Задати запитання на тендер
  ...
  capitalua.Задати питання  ${username}  ${tender_uaid}  ${question}

Задати запитання на предмет
  [Arguments]  ${username}  ${tender_uaid}  ${item_id}  ${question}
  capitalua.Задати питання  ${username}  ${tender_uaid}  ${question}  ${item_id}
...
Отримати документ
  ...
  capitalua_download_file   ${url}  ${file_name}  ${OUTPUT_DIR}
  [return]  ${file_name}
...
Отримати інформацію із документа по індексу
  ...
  ${doc_value}=  convert_string_from_dict_capitalua  ${doc_value}
  [return]  ${doc_value}
...
Подати цінову пропозицію
  ...
  ...  Go To  https://eauction-capital.com.ua/bids/send/${url.split('?')[0].split('/')[-1]}
  ...  ELSE  Go To  https://eauction-capital.com.ua/bids/decline/${url.split('?')[0].split('/')[-1]}
  Go To  ${url}
...
Змінити цінову пропозицію
  ...
  ${file_path}=  get_upload_file_path
  capitalua.Пошук тендера по ідентифікатору   ${username}  ${tender_uaid}
  capitalua.Скасувати цінову пропозицію  ${username}  ${tender_uaid}
  Wait Until Element Is Visible   xpath=//input[contains(@name, '[value][amount]')]
...
Завантажити документ в ставку
  ...
  capitalua.Пошук тендера по ідентифікатору   ${username}  ${tender_uaid}
  ${value}=  capitalua.Отримати інформацію із пропозиції  ${username}  ${tender_uaid}  ${EMPTY}
  capitalua.Скасувати цінову пропозицію  ${username}  ${tender_uaid}
  Wait Until Element Is Visible   xpath=//input[contains(@name, '[value][amount]')]
...
Завантажити фінансову ліцензію
  [Arguments]  ${username}  ${tender_uaid}  ${filepath}
  capitalua.Завантажити документ в ставку  ${username}  ${filepath}  ${tender_uaid}

Змінити документ в ставці
  [Arguments]  ${username}  ${tender_uaid}  ${path}  ${docid}
  capitalua.Завантажити документ в ставку  ${username}  ${path}  ${tender_uaid}
...
Conv And Select From List By Value
  ...
  ${smth_to_select}=  convert_string_from_dict_capitalua  ${smth_to_select}
  Select From List By Value  ${elem_locator}  ${smth_to_select}

Input Date
  [Arguments]  ${elem_locator}  ${date}
  ${date}=  convert_datetime_to_capitalua_format  ${date}
